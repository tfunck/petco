...
//void voxel_vertexPairs(vector** vertices, double maxima[3], double minima[3], double step[3], unsigned short* voxelArray,  double xmin, double ymin, double zmin, vector vtx_min, vector vtx_max, misize_t* count );
...
void blurImage( misize_t *sizes, double* step, float*** voxeldata, float fwhm);
